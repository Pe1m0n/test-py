...
class TCPClient:
    """
    јсинхронный TCP клиент.

    ќтвечает за подключение к серверу, отправку PING-запросов,
    приЄм и разбор сообщений, логирование результатов и ошибок.
    """
    ...
    def setup_logging(self) -> None:
        """Ќастройка двух раздельных логгеров: событий и ошибок."""
        # событи¤
    ...
    async def connect(self) -> None:
        """ќткрывает соединение с сервером."""
        try:
    ...
    async def send_ping(self, request_number: int) -> None:
        """ќтправка одного PING-запроса вида: "[N] PING\n"."""
        try:
